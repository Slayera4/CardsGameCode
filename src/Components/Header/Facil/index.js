        ...
        return(
         <IntlProvider locale={this.props.translates.locale} messages={this.props.translates.messages}>
            <Container>
                ...
                <Title>
                   <FormattedMessage id="app.info1" values={{attempts: <p>{this.props.Game1.numberAttempts}</p>}}/>
                </Title>
                <Title>
                    <FormattedMessage id="app.info2" values={{hits:<p>{this.props.Game1.hits}</p>}}/>
                </Title>
            </Container>
        </IntlProvider>
        );
...
export default connect(({Game1,translates}) => ({Game1,translates}))(Header);
